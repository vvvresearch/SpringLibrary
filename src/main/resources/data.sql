...
INSERT into GENRE (genre_id, genre_name) values (2, 'Рассказ');
INSERT into GENRE (genre_id, genre_name) values (3, 'Новелла');
INSERT into GENRE (genre_id, genre_name) values (4, 'Стихи');
INSERT into GENRE (genre_id, genre_name) values (5, 'Поэма');
